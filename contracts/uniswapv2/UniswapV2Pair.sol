...
contract UniswapV2Pair is UniswapV2ERC20 {
    ...
    returns (bool feeOn)
  {
    ...
    uint256 mintFeeDenominator = IUniswapV2Factory(factory)
      .mintFeeToDenominator();
    feeOn = feeTo != address(0) && mintFeeDenominator != 0;
    ...
    returns (uint256 amount0, uint256 amount1)
  {
    ...
    uint256 balance0 = IERC20Uniswap(_token0).balanceOf(
      address(this)
    );
    uint256 balance1 = IERC20Uniswap(_token1).balanceOf(
      address(this)
    );
